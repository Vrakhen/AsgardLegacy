...
namespace AsgardLegacy
{
	class Configs_Berserker
	{
		...
		public static ConfigEntry<float> al_svr_berserker_siphonLife_radius;
		public static ConfigEntry<float> al_svr_berserker_siphonLife_healthGainPercentMin;
		public static ConfigEntry<float> al_svr_berserker_siphonLife_healthGainPercentMax;
		public static ConfigEntry<float> al_svr_berserker_siphonLife_staminaGainPercentMin;
		public static ConfigEntry<float> al_svr_berserker_siphonLife_staminaGainPercentMax;
		...
		public static ConfigEntry<float> al_svr_berserker_rebuke_reflectPercentMin;
		public static ConfigEntry<float> al_svr_berserker_rebuke_reflectPercentMax;
		...
		{
			al_svr_berserker_charge_staminaCost = config.Bind("Berserker", "al_svr_berserker_charge_staminaCost", 25f);
			...
			al_svr_berserker_dreadfulRoar_staminaCost = config.Bind("Berserker", "al_svr_berserker_dreadfulRoar_staminaCost", 35f);
			...
			al_svr_berserker_dreadfulRoar_slowValueMax = config.Bind("Berserker", "al_svr_berserker_dreadfulRoar_slowValueMax", .25f);
			al_svr_berserker_dreadfulRoar_weakenValueMin = config.Bind("Berserker", "al_svr_berserker_dreadfulRoar_weakenValueMin", .8f);
			al_svr_berserker_dreadfulRoar_weakenValueMax = config.Bind("Berserker", "al_svr_berserker_dreadfulRoar_weakenValueMax", .2f);
			...
			al_svr_berserker_frenzy_attackSpeedMultiplierMin = config.Bind("Berserker", "al_svr_berserker_frenzy_attackSpeedMultiplierMin", 1.25f);
			...
			al_svr_berserker_twoHandedExpert_staminaBonusMin = config.Bind("Berserker", "al_svr_berserker_twoHandedExpert_staminaBonusMin", .9f);
			al_svr_berserker_twoHandedExpert_staminaBonusMax = config.Bind("Berserker", "al_svr_berserker_twoHandedExpert_staminaBonusMax", .5f);
			...
			al_svr_berserker_siphonLife_radius = config.Bind("Berserker", "al_svr_berserker_siphonLife_radius", 15f);
			al_svr_berserker_siphonLife_healthGainPercentMin = config.Bind("Berserker", "al_svr_berserker_siphonLife_healthGainPercentMin", .05f);
			al_svr_berserker_siphonLife_healthGainPercentMax = config.Bind("Berserker", "al_svr_berserker_siphonLife_healthGainPercentMax", .25f);
			al_svr_berserker_siphonLife_staminaGainPercentMin = config.Bind("Berserker", "al_svr_berserker_siphonLife_staminaGainPercentMin", .05f);
			al_svr_berserker_siphonLife_staminaGainPercentMax = config.Bind("Berserker", "al_svr_berserker_siphonLife_staminaGainPercentMax", .25f);

			GlobalConfigs_Berserker.ConfigStrings.Add("al_svr_berserker_siphonLife_radius", al_svr_berserker_siphonLife_radius.Value);
			GlobalConfigs_Berserker.ConfigStrings.Add("al_svr_berserker_siphonLife_healthGainPercentMin", al_svr_berserker_siphonLife_healthGainPercentMin.Value);
			GlobalConfigs_Berserker.ConfigStrings.Add("al_svr_berserker_siphonLife_healthGainPercentMax", al_svr_berserker_siphonLife_healthGainPercentMax.Value);
			GlobalConfigs_Berserker.ConfigStrings.Add("al_svr_berserker_siphonLife_staminaGainPercentMin", al_svr_berserker_siphonLife_staminaGainPercentMin.Value);
			GlobalConfigs_Berserker.ConfigStrings.Add("al_svr_berserker_siphonLife_staminaGainPercentMax", al_svr_berserker_siphonLife_staminaGainPercentMax.Value);
			...
			al_svr_berserker_rebuke_reflectPercentMin = config.Bind("Berserker", "al_svr_berserker_rebuke_reflectPercentMin", .05f);
			al_svr_berserker_rebuke_reflectPercentMax = config.Bind("Berserker", "al_svr_berserker_rebuke_reflectPercentMax", .25f);

			GlobalConfigs_Berserker.ConfigStrings.Add("al_svr_berserker_rebuke_reflectPercentMin", al_svr_berserker_rebuke_reflectPercentMin.Value);
			GlobalConfigs_Berserker.ConfigStrings.Add("al_svr_berserker_rebuke_reflectPercentMax", al_svr_berserker_rebuke_reflectPercentMax.Value);

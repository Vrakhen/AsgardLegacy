...
namespace AsgardLegacy
{
	class Configs_Common
	{
		...
		public static ConfigEntry<float> al_svr_passive5UnlockLevel;
		public static ConfigEntry<float> al_svr_passive6UnlockLevel;
		...
		public static void InitializeConfig(ConfigFile config)
		{
			...
			al_svr_passive3UnlockLevel = config.Bind("Common", "al_svr_passive3UnlockLevel", 12f);
			al_svr_passive4UnlockLevel = config.Bind("Common", "al_svr_passive4UnlockLevel", 14f);
			al_svr_passive5UnlockLevel = config.Bind("Common", "al_svr_passive5UnlockLevel", 18f);
			al_svr_passive6UnlockLevel = config.Bind("Common", "al_svr_passive6UnlockLevel", 20f);
			...
			GlobalConfigs.ConfigStrings.Add("al_svr_passive5UnlockLevel", al_svr_passive5UnlockLevel.Value);
			GlobalConfigs.ConfigStrings.Add("al_svr_passive6UnlockLevel", al_svr_passive6UnlockLevel.Value);

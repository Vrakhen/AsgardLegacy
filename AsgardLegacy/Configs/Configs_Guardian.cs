...
namespace AsgardLegacy
{
	class Configs_Guardian
	{
		...
		public static ConfigEntry<float> al_svr_guardian_immovable_pushReductionMin;
		public static ConfigEntry<float> al_svr_guardian_immovable_pushReductionMax;

		public static ConfigEntry<float> al_svr_guardian_absorbElements_percentMin;
		public static ConfigEntry<float> al_svr_guardian_absorbElements_percentMax;
		...
		{
			al_svr_guardian_shatterFall_staminaCost = config.Bind("Guardian", "al_svr_guardian_shatterFall_staminaCost", 25f);
			...
			al_svr_guardian_aegis_staminaCost = config.Bind("Guardian", "al_svr_guardian_aegis_staminaCost", 35f);
			...
			al_svr_guardian_aegis_armorMultiplierMin = config.Bind("Guardian", "al_svr_guardian_aegis_armorMultiplierMin", 1.25f);
			...
			al_svr_guardian_retribution_duration = config.Bind("Guardian", "al_svr_guardian_retribution_duration", 10f);
			...
			al_svr_guardian_warCry_radius = config.Bind("Guardian", "al_svr_guardian_warCry_radius", 10f);
			...
			al_svr_guardian_immovable_pushReductionMin = config.Bind("Guardian", "al_svr_guardian_immovable_pushReductionMin", .5f);
			al_svr_guardian_immovable_pushReductionMax = config.Bind("Guardian", "al_svr_guardian_immovable_pushReductionMax", 1f);

			GlobalConfigs_Guardian.ConfigStrings.Add("al_svr_guardian_immovable_pushReductionMin", al_svr_guardian_immovable_pushReductionMin.Value);
			GlobalConfigs_Guardian.ConfigStrings.Add("al_svr_guardian_immovable_pushReductionMax", al_svr_guardian_immovable_pushReductionMax.Value);

			al_svr_guardian_absorbElements_percentMin = config.Bind("Guardian", "al_svr_guardian_absorbElements_percentMin", .5f);
			al_svr_guardian_absorbElements_percentMax = config.Bind("Guardian", "al_svr_guardian_absorbElements_percentMax", 1f);

			GlobalConfigs_Guardian.ConfigStrings.Add("al_svr_guardian_absorbElements_percentMin", al_svr_guardian_absorbElements_percentMin.Value);
			GlobalConfigs_Guardian.ConfigStrings.Add("al_svr_guardian_absorbElements_percentMax", al_svr_guardian_absorbElements_percentMax.Value);

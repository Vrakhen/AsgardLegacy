...
namespace AsgardLegacy
{
	class GlobalConfigs_Berserker
	{
		...
		public static float al_svr_berserker_siphonLife_radius
		{ get { return ConfigStrings.ContainsKey("al_svr_berserker_siphonLife_radius") ? ConfigStrings["al_svr_berserker_siphonLife_radius"] : 1f; } }
		public static float al_svr_berserker_siphonLife_healthGainPercentMin
		{ get { return ConfigStrings.ContainsKey("al_svr_berserker_siphonLife_healthGainPercentMin") ? ConfigStrings["al_svr_berserker_siphonLife_healthGainPercentMin"] : 1f; } }
		public static float al_svr_berserker_siphonLife_healthGainPercentMax
		{ get { return ConfigStrings.ContainsKey("al_svr_berserker_siphonLife_healthGainPercentMax") ? ConfigStrings["al_svr_berserker_siphonLife_healthGainPercentMax"] : 1f; } }
		public static float al_svr_berserker_siphonLife_staminaGainPercentMin
		{ get { return ConfigStrings.ContainsKey("al_svr_berserker_siphonLife_staminaGainPercentMin") ? ConfigStrings["al_svr_berserker_siphonLife_staminaGainPercentMin"] : 1f; } }
		public static float al_svr_berserker_siphonLife_staminaGainPercentMax
		{ get { return ConfigStrings.ContainsKey("al_svr_berserker_siphonLife_staminaGainPercentMax") ? ConfigStrings["al_svr_berserker_siphonLife_staminaGainPercentMax"] : 1f; } }
		...
		public static float al_svr_berserker_rebuke_reflectPercentMin
		{ get { return ConfigStrings.ContainsKey("al_svr_berserker_rebuke_reflectPercentMin") ? ConfigStrings["al_svr_berserker_rebuke_reflectPercentMin"] : 0f; } }
		public static float al_svr_berserker_rebuke_reflectPercentMax
		{ get { return ConfigStrings.ContainsKey("al_svr_berserker_rebuke_reflectPercentMax") ? ConfigStrings["al_svr_berserker_rebuke_reflectPercentMax"] : 0f; } }

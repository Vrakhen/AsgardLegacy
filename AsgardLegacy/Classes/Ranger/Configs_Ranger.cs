...
namespace AsgardLegacy
{
	class Configs_Ranger
	{
		...
		{
			al_svr_ranger_explosiveArrow_staminaCost = config.Bind("Ranger", "al_svr_ranger_explosiveArrow_staminaCost", 50f);
			...
			al_svr_ranger_shadowStalk_staminaCost = config.Bind("Ranger", "al_svr_ranger_shadowStalk_staminaCost", 25f);
			al_svr_ranger_shadowStalk_cooldown = config.Bind("Ranger", "al_svr_ranger_shadowStalk_cooldown", 300f);
			...
			al_svr_ranger_rapidFire_cooldown = config.Bind("Ranger", "al_svr_ranger_rapidFire_cooldown", 180f);
			...
			al_svr_ranger_rangerMark_durationMin = config.Bind("Ranger", "al_svr_ranger_rangerMark_durationMin", 5f);
			al_svr_ranger_rangerMark_durationMax = config.Bind("Ranger", "al_svr_ranger_rangerMark_durationMax", 5f);
			al_svr_ranger_rangerMark_damageMultiplierMin = config.Bind("Ranger", "al_svr_ranger_rangerMark_damageMultiplierMin", 1.1f);
